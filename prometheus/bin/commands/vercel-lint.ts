/**
 * prometheus vercel:lint — governance scan for Vercel deployment configuration.
 *
 * Usage:
 *   prometheus vercel:lint              # Scan vercel.json + env vars + cron routes
 *   prometheus vercel:lint --json       # JSON output for CI
 *   prometheus vercel:lint --strict     # Also flag MEDIUM severity
 *   prometheus vercel:lint --fix        # Show suggested fixes inline
 */
