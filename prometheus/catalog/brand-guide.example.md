# Brand Guide
# Copy this file to `.prometheus/brand-guide.md` in your project and fill it in.
...
## Design Config (`.prometheus/config.json`)

Prometheus design rules work out of the box for any stack, but you can customize the scales and library list in your `.prometheus/config.json`. All fields are optional — only set what differs from the defaults.
